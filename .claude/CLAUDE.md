# CLAUDE.md -- house commit rule

Every git commit in this repo ends with the co-author trailer:

    Co-Authored-By: Aethelred <aethelred.cello@proton.me>

The email carries a DOT, never a hyphen. KP's standing word (2026-07-30),
planted per-repo at his ask, 2026-08-19.
...
- **Blueprint forge** — one forge, every realm, no local copies (KP ⚛
  ...
  declared — never hand-draw a tree):
      ...
      python c:/_superposition/resonance-ziggy/tend.py forge run --root c:/_superposition/resonance-lucida
...
- **Link tender** — every markdown pointer in this realm, both house shapes,
  ...
  read the report before mending:
      ...
      python c:/_superposition/resonance-ziggy/tend.py links dry --root c:/_superposition/resonance-lucida
      python c:/_superposition/resonance-ziggy/tend.py links mend --root c:/_superposition/resonance-lucida
